...
class Trainer:
    ...
    def get_optimizer_cls_and_kwargs(args: TrainingArguments) -> Tuple[Any, Any]:
        ...
        admetar_kwargs = {
            "betas": (args.admetar_beta1, args.admetar_beta2),
            "eps": args.admetar_epsilon,
            "lamda":args.admetar_lamda,
            "k":args.admetar_k,
        }

        admetas_kwargs = {
            "beta": args.admetas_beta,
            "lamda":args.admetas_lamda,
            "k":args.admetas_k,
        }
        ranger_kwargs = {
            "betas": (args.ranger_beta1, args.ranger_beta2),
            "eps": args.ranger_epsilon,
            "alpha": args.ranger_alpha,
            "k":args.ranger_k, 
        }
        radam_kwargs = {
            "betas": (args.radam_beta1, args.radam_beta2),
            "eps": args.radam_epsilon,
        }
        adabelief_kwargs = {
            "betas": (args.adabelief_beta1, args.adabelief_beta2),
            "eps": args.adabelief_epsilon,
        }
        ...
        if args.optim == OptimizerNames.ADAFACTOR:
        ...
        elif args.optim == OptimizerNames.RAdam:
            from .optimization import RAdam

            optimizer_cls = RAdam
            optimizer_kwargs.update(radam_kwargs)
        elif args.optim == OptimizerNames.AdaBelief:
            from .optimization import AdaBelief
            ...
            optimizer_cls = AdamW
            optimizer_kwargs.update(adam_kwargs)
        elif args.optim == OptimizerNames.AdmetaR:
            from .optimization import AdmetaR

            optimizer_cls = AdmetaR
            optimizer_kwargs.update(admetar_kwargs)
        elif args.optim == OptimizerNames.AdmetaS:
            from .optimization import AdmetaS

            optimizer_cls = AdmetaS
            optimizer_kwargs.update(admetas_kwargs)
        elif args.optim == OptimizerNames.Ranger:
            from .optimization import Ranger

            optimizer_cls = Ranger
            optimizer_kwargs.update(ranger_kwargs)
