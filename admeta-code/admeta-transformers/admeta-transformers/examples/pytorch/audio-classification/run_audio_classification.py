...
def main():
    ...
    raw_datasets["train"] = load_dataset(
        './superb.py' if data_args.dataset_name == 'superb' else ('./common_language.py' if data_args.dataset_name == 'common_language' else data_args.dataset_name),
        data_args.dataset_config_name,
        split=data_args.train_split_name,
        use_auth_token=True if model_args.use_auth_token else None,
    )
    raw_datasets["eval"] = load_dataset(
        './superb.py' if data_args.dataset_name == 'superb' else data_args.dataset_name,
        data_args.dataset_config_name,
